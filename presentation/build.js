...
(async () => {
  ...
  s.addText("Кейс 5 • Хакатон 2026 • живое демо: https://plan-wise.ru", {
  ...
  const works = [
    ...
    "Загрузка своего материала (PDF/DOCX/TXT) как основы сценария",
    "Редактор: добавление/удаление и reorder этапов ↑/↓, точечная регенерация с выбором типа, версии",
