...
- **Docker-образ для self-host раздачи (2026-05-23, ветка `feat/docker-offline`, коммит `9162bea`, НЕ в master):** реализован «Поток 1» — runtime Docker-образ + compose, чтобы отдавать развёртывание сторонним людям (закрывает backlog #9). Worktree `.claude/worktrees/feat-docker-offline`.
