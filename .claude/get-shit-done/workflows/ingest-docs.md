...
```bash
INIT=$(node "/home/nikit/planwise/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/nikit/planwise/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
