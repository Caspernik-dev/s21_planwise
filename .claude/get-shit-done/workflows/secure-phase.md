...
```
Agent(
  prompt="Read /home/nikit/planwise/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/nikit/planwise/.claude/get-shit-done/templates/SECURITY.md`
