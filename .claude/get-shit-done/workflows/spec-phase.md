...
```bash
INIT=$(node "/home/nikit/planwise/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/nikit/planwise/.claude/get-shit-done/templates/spec.md.
