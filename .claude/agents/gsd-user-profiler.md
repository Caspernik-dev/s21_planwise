...
<reference>
@/home/nikit/planwise/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/nikit/planwise/.claude/get-shit-done/references/user-profiling.md` to load:
