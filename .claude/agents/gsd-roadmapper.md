...
Reference full template: `/home/nikit/planwise/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/nikit/planwise/.claude/get-shit-done/templates/state.md`.
