...
- Пиши блоки ПРЯМОЙ РЕЧЬЮ: "Учитель: ..." — конкретные реплики, которые учитель проговаривает дословно. Для шагов эксперимента/исследования — "Шаг 1: ...", "Шаг 2: ...". НЕ ПЕРЕСКАЗЫВАЙ в третьем лице ("учитель объясняет", "учитель предлагает") — это водянисто.
