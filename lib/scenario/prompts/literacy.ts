...
- Пиши блоки ПРЯМОЙ РЕЧЬЮ: "Учитель: ..." — конкретные реплики, которые учитель проговаривает дословно. Для условий задач допускается "Кейс: ...", для шагов разбора — "Шаг 1: ...". НЕ ПЕРЕСКАЗЫВАЙ в третьем лице ("учитель спрашивает", "учитель предлагает") — это водянисто.
