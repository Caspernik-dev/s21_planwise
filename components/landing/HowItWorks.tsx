...
const STEPS = [
  {
    ...
    description:
      'Укажите направление, класс, тему и формат занятия — пара полей формы, никакого промпт-инжиниринга.',
  },
  {
    icon: Cpu,
    title: 'ИИ генерирует с опорой на методички',
    description:
      'Система находит релевантные материалы и собирает структуру и детали сценария в реальном времени.',
  },
  {
    icon: FileEdit,
    title: 'Отредактируйте и экспортируйте',
    description: 'Поправьте блоки, добавьте своё и выгрузите готовый сценарий в PDF или DOCX.',
  },
]
